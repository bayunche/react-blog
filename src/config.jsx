...
// API_BASE_URL
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://127.0.0.1:6060'
// SERVER_URL (兼容性别名)
...
export const GITHUB = {
  ...
  client_id: import.meta.env.VITE_GITHUB_CLIENT_ID, // Setting > Developer setting > OAuth applications => client_id
